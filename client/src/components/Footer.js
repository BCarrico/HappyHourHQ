...
export default function Footer() {
	return (
        <footer className="flex flex-col items-center md:flex-row md:justify-between p-4 bg-gray-800 text-gray-300">
            <div className="items-center grid-flow-col p-2">
                ...
                <p>© 2022 Happy Hour HQ - All right reserved</p>
            </div> 
            <div className="flex gap-4 p-2 md:place-self-center md:justify-self-end">
                <a href="https://carrib.netlify.app" target="_blank">Developed By: Brad Carrico</a>
